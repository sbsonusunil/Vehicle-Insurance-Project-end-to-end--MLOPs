...
from vehicleInsurance.constants import DATA_VALIDATION_SCHEMA_FILE_PATH
from vehicleInsurance.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from vehicleInsurance.entity.config_entity import DataValidationConfig
from vehicleInsurance.exception import VehicleInsuranceException
from vehicleInsurance.logger import logger
from vehicleInsurance.utils.main_utils import read_yaml_file, write_yaml_file
...
class DataValidation:
    ...
    def validate_number_of_columns(self, dataframe: pd.DataFrame) -> bool:
        try:
            ...
            logger.info(f"Required columns: {number_of_columns}, Available columns: {len(dataframe.columns)}")
